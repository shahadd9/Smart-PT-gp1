...
def fiveDay(level,d):
   ...
   def getfullbodyForce():
       return fullbodyforce

   def getfullbodygeneralmuscle():
       return fullbodygeneralmuscle




   def getupperName():
       return upperbodyname
   

   def getupperForce():
       return upperbodyforce

   def getuppergeneralmuscle():
       return upperbodygeneralmuscle



   def getlowerName():
       return lowerbodyname
